  ...
  try {
    ...
    const storedResult = await prisma.checkResult.create({
      data: {
        ...
        responseTime: quickResult.responseTime ?? null,
        statusCode: quickResult.statusCode ?? null,
        errorMessage: quickResult.errorMessage ?? null,
        dnsTime: quickResult.dnsTime ?? null,
        tcpTime: quickResult.tcpTime ?? null,
        tlsTime: quickResult.tlsTime ?? null,
        ttfbTime: quickResult.ttfbTime ?? null,
        downloadTime: quickResult.downloadTime ?? null,
        totalTime: quickResult.totalTime ?? null,
        details: quickResult.details ?? null,
      },
    });
